...
describe("runCustomGates", async () => {
  ...
  // -----------------------------------------------------------------------
  it("returns passed with empty checks when no custom gates are configured", async () => {
    const config = makeConfig([]);

    const result = await runCustomGates("pre_task", "1.1.1", config, "/project");
  ...
  // -----------------------------------------------------------------------
  it("filters out gates for a different position and returns passed", async () => {
    const config = makeConfig([
  ...
  // -----------------------------------------------------------------------
  it("returns passed with one check when a single gate succeeds", async () => {
    const config = makeConfig([
  ...
  // -----------------------------------------------------------------------
  it("returns failed with one check when a single gate fails", async () => {
    const config = makeConfig([
    ...
    const result = await runCustomGates("post_task", "1.1.1", config, "/project");
  ...
  // -----------------------------------------------------------------------
  it("short-circuits on first failure and only returns checks up to that point", async () => {
    const config = makeConfig([
    ...
    const result = await runCustomGates("pre_review", "1.1.1", config, "/project");
  ...
  // -----------------------------------------------------------------------
  it("returns passed with all checks when every gate succeeds", async () => {
    const config = makeConfig([
    ...
    const result = await runCustomGates("post_accept", "1.1.1", config, "/project");
  ...
  // -----------------------------------------------------------------------
  it("prefixes check names with 'custom:' and the gate name", async () => {
    const config = makeConfig([
  ...
  // -----------------------------------------------------------------------
  it("passes cwd and timeout_ms to runCommand", async () => {
    const config = makeConfig([
    ...
    await runCustomGates("pre_task", "1.1.1", config, "/my/project");
  ...
  // -----------------------------------------------------------------------
  it("passes undefined timeout_ms when not configured on the gate", async () => {
    const config = makeConfig([
    ...
    await runCustomGates("pre_task", "1.1.1", config, "/project");
